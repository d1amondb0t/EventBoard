...
namespace PFservice
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ProjetEvenementsContext>(o=>o.UseMySQL("server=localhost;user id=root;persistsecurityinfo=True;allowpublickeyretrieval=True;sslmode=None;port=3306;database=projetevenements"));
