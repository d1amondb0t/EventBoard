...
namespace PFservice
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ProjetEvenementsContext>(o=>o.UseMySQL("server=db_event_board;userid=root;persistsecurityinfo=True;allowpublickeyretrieval=True;sslmode=None;port=3306;database=projetevenements"));
